    ...
    return (
      <div className="boss-banner glass-card">
        ...
        <div className="conversion-fact-box" style={{ marginBottom: 20 }}>
          🔑 Remember: <span className="mass-value">Fraction = Decimal (same amount!)</span>
        </div>
  ...
  if (won) {
    return (
      ...
      >
        ...
        <p style={{ color: 'var(--gold)', fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: '1.25rem' }}>
  ...
  return (
    <div style={{ position: 'relative', width: '100%' }}>
      ...
      <FeedbackOverlay
        ...
        message={selected === question?.correctAnswer ? "That's exactly right! Well done! 🎉" : "Not quite! Remember: tenths = 1 digit, hundredths = 2 digits"}
